...
Contexto (memoria relevante): - {mem}
Historial reciente:{recent}
Instrucciones:
- Responde en español, claro y breve.
- Mantén coherencia con el contexto.
...
Asistente:";
        ...
        {
            return $@"Resume la siguiente conversación a 1-2 frases (hechos, decisiones o relaciones), en español, conciso: ""{transcript}""";
        }
    }
}
